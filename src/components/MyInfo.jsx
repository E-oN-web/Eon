...
export default function Myinfo() {
  return (
    <div className="bg-backDark text-white">
      <div className="px-4 sm:px-0">
        <h3 className="text-base font-semibold leading-7 text-white">
          내 정보
        </h3>
        <p className="mt-1 max-w-2xl text-sm leading-6 text-white"></p>
      </div>
      <div className="mt-6 border-t-4 border-hori">
        <dl className="divide-y divide-hori">
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            <dt className="text-sm font-medium leading-6 text-semiTitle">
              Full name
            </dt>
